...
<div class="w-full text-blue-700 bg-white dark-mode:text-blue-200 dark-mode:bg-blue-800">
    <div x-data="{ open: false }"
        ...
        <div class="p-4 flex flex-row items-center justify-between">
            <a href="#"
                class="text-lg font-semibold tracking-widest text-blue-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Centre
                de santé Mamadou Diop
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-blue-800">
                        <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-blue-600 dark-mode:focus:bg-blue-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-blue-200 md:mt-0 hover:text-blue-900 focus:text-blue-900 hover:bg-blue-200 focus:bg-blue-200 focus:outline-none focus:shadow-outline"
                            href="/connection">SE connecter</a>
                        <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-blue-600 dark-mode:focus:bg-blue-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-blue-200 md:mt-0 hover:text-blue-900 focus:text-blue-900 hover:bg-blue-200 focus:bg-blue-200 focus:outline-none focus:shadow-outline"
